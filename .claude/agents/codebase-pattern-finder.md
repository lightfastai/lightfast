...
description: Finds similar implementations, usage examples, or existing patterns that can be modeled after. Gives concrete code examples based on what you're looking for.
...
### Related Utilities
- `src/utils/helper.js:12` - Shared helpers
```
