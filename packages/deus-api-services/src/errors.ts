...
import { DeusApiError } from "./base-service";

// Re-export DeusApiError for convenience
export { DeusApiError };
...
export function isTRPCClientError(
  error: unknown,
): error is DeusApiError | TRPCError {
  return error instanceof DeusApiError || error instanceof TRPCError;
}
...
export function getUserFriendlyErrorMessage(error: unknown): string {
  ...
  if (error instanceof DeusApiError || error instanceof TRPCError) {
