...
/**
 * Input provided to the code interpreter tool.
 */
export interface CodeInterpreterToolInput {
  task: string;
  context?: string;
  preferredRuntime?: "python3.13" | "node22";
}

/**
 * Artifact generated by the code interpreter tool run.
 */
/**
 * Output returned by the code interpreter tool.
 */
...
export type LightfastAppChatToolSet = {
  ...
  codeInterpreter: {
    ...
    output: CodeInterpreterToolOutput;
  };
};
...
export type CodeInterpreterToolUIPart = ToolUIPartState<
  "codeInterpreter",
...
/**
 * Runtime configuration required by the code interpreter tool.
 */
export interface CodeInterpreterToolRuntimeConfig {
  model: LanguageModel;
  defaultRuntime?: "python3.13" | "node22";
  timeoutMs?: number;
}
...
export interface ToolRuntimeConfig {
  ...
  codeInterpreter?: CodeInterpreterToolRuntimeConfig;
}
