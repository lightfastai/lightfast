 ...
 */
export function fileTool(context: RuntimeContext) {
	return tool({
 ...
 */
export function fileReadTool(context: RuntimeContext) {
	return tool({
 ...
 */
export function fileDeleteTool(context: RuntimeContext) {
	return tool({
 ...
 */
export function fileStringReplaceTool(context: RuntimeContext) {
	return tool({
 ...
 */
export function fileFindInContentTool(context: RuntimeContext) {
	return tool({
 ...
 */
export function fileFindByNameTool(context: RuntimeContext) {
	return tool({
