...
import { createConstrainedVec1, VectorMode } from "../../schema/schema";
...
export const $Limit = z.object({
  ...
  u_quantizationSteps: createConstrainedVec1({
    mode: VectorMode.Number,
    components: {
      x: { min: 1, max: 256, default: 1.01 },
    },
