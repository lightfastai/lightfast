...
async function main() {
  ...
  const lines = [
    "// AUTO-GENERATED by packages/app-remotion/src/render-lissajous.ts",
    "// Do not edit manually. Regenerate with: pnpm --filter @repo/app-remotion render:lissajous",
    "",
    "export const LISSAJOUS_PATHS: readonly { name: string; d: string }[] = [",
