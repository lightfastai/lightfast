...
/**
 * Sentry webhook event types matching the real wire format (sentry-hook-resource header).
 * The action (created, resolved, etc.) comes from the payload body, not the wire eventType.
 */
