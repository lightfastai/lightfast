...
describe("findUnmatchedDomains", () => {
  it("returns unknown domains not in registry", () => {
    const networkDomains = new Set(["unknown-tool.com", "another-unknown.io"]);
  ...
  it("matches via exact known domain", () => {
    const networkDomains = new Set(["clerk.com", "sentry.io"]);
    const result = findUnmatchedDomains(
      networkDomains,
      "example.com",
      testSignatures
  ...
  it("matches via regex patterns", () => {
    const networkDomains = new Set(["app.posthog.com", "cdn.sentry.io"]);
    const result = findUnmatchedDomains(
      networkDomains,
      "example.com",
      testSignatures
  ...
  it("returns sorted results", () => {
    const networkDomains = new Set(["zebra.io", "alpha.com", "middle.net"]);
    const result = findUnmatchedDomains(
      networkDomains,
      "example.com",
      testSignatures
  ...
  it("returns empty array when all domains are known", () => {
    const networkDomains = new Set(["example.com", "clerk.com", "sentry.io"]);
    const result = findUnmatchedDomains(
      networkDomains,
      "example.com",
      testSignatures
