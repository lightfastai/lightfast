 ...
 *
 * Type Safety:
 * All enum values are type-checked against validation schemas (@repo/app-validation).
 * This ensures config values can never violate database constraints.
 *
 * Single Source of Truth:
 * Core embedding defaults are defined in @repo/app-validation/constants.
 ...
 * @example
 * ```typescript
 * import { PRIVATE_CONFIG } from "@repo/app-config/private";
 *
