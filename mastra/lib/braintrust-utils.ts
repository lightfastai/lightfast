...
export async function evaluateTaskCompletion(
	...
	const completionIndicators = [
		"done", "completed", "finished", "ready", "success",
		"created", "generated", "saved", "processed"
	];
...
export async function evaluateResponseQuality(response: string): Promise<number> {
	...
	const helpfulPhrases = [
		...
		"solution", "approach", "method", "way to"
	];
	
	const hasHelpfulContent = helpfulPhrases.some(phrase => 
