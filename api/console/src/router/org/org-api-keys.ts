 ...
 *
 * Security:
 * - Keys are generated by Unkey with sk_ prefix
...
export const orgApiKeysRouter = {
  ...
  create: orgScopedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      // Unkey keys look like: sk_<random> — take last 4 chars of the full key
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      await recordCriticalActivity({
        ...
        metadata: {
          ...
          keyName: existingKey.name,
          newKeyPreview: `sk_...${newKeySuffix}`,
        },
