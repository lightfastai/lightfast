CREATE TABLE "lightfast_user_api_keys" (
...
CREATE INDEX "api_key_user_id_idx" ON "lightfast_user_api_keys" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "api_key_is_active_idx" ON "lightfast_user_api_keys" USING btree ("is_active");--> statement-breakpoint
CREATE INDEX "api_key_hash_idx" ON "lightfast_user_api_keys" USING btree ("key_hash");--> statement-breakpoint
