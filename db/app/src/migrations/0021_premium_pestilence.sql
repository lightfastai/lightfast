...
--> statement-breakpoint
CREATE INDEX `developer_sandbox_commands_run_status_idx` ON `lightfast_org_developer_sandbox_commands` (`sandbox_run_id`,`status`);--> statement-breakpoint
CREATE INDEX `developer_sandbox_commands_org_actor_created_idx` ON `lightfast_org_developer_sandbox_commands` (`clerk_org_id`,`actor_user_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `developer_sandbox_runs_org_actor_status_idx` ON `lightfast_org_developer_sandbox_runs` (`clerk_org_id`,`actor_user_id`,`status`);--> statement-breakpoint
CREATE INDEX `developer_sandbox_runs_expires_status_idx` ON `lightfast_org_developer_sandbox_runs` (`expires_at`,`status`);