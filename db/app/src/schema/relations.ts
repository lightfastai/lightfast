...
// Surviving tables (lightfast_org_user_activities, lightfast_workspace_api_keys)
// have no inter-table FK relationships — they reference Clerk org IDs as opaque
// strings.
//
