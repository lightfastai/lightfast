...
--> statement-breakpoint
ALTER TABLE `lightfast_deus_organization_members` ADD CONSTRAINT `lightfast_deus_organization_members_organization_id_lightfast_deus_organizations_id_fk` FOREIGN KEY (`organization_id`) REFERENCES `lightfast_deus_organizations`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
