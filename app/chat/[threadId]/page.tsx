...
import { ThinkingAnimation } from "@/src/components/thinking-animation";
import { TaskAccordion } from "@/src/components/task-accordion";
		...
		<main className="flex h-screen flex-col relative">
			...
			{messages.length === 0 ? (
				...
				<div className="flex-1 flex flex-col relative overflow-hidden">
					...
					{/* Chat input positioned at the bottom with gradient above */}
					<div className="absolute bottom-0 left-0 right-0 pb-4">
						{/* Gradient fade overlay */}
						<div className="absolute bottom-full left-0 right-0 h-24 -mb-8 bg-gradient-to-t from-background via-background via-[60%] to-transparent pointer-events-none" />
