...
export function AgentDemo() {
	const [query, setQuery] = useState(`Can you write a JavaScript function that calculates the factorial of a number? 
	...
	return (
		<Card className="w-full max-w-4xl">
			<CardHeader>
				...
				<CardDescription>
					Ask the AI agent to help with coding tasks. It can write, test, and explain code using the Vercel Sandbox.
				</CardDescription>
			</CardHeader>
