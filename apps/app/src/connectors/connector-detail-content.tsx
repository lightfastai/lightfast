      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-5 pb-5">
        ...
        <div className="flex flex-col">
          ...
          {isUserConnection ? (
            <>
              <PropertyRow
                icon={<HugeiconsIcon icon={MessageCircle} className={iconClass} />}
                label="Availability"
              >
              ...
              {connection.providerAccountName ? (
                <PropertyRow
                  icon={<HugeiconsIcon icon={User} className={iconClass} />}
                  label="Account"
                >
                  {connection.providerAccountName}
                </PropertyRow>
            ...
            <>
              {connection.providerWorkspaceName ? (
                <PropertyRow
                  icon={<HugeiconsIcon icon={Building2} className={iconClass} />}
                  label="Workspace"
                >
                  {connection.providerWorkspaceName}
                </PropertyRow>
          ...
          <PropertyRow
            icon={<HugeiconsIcon icon={CalendarDays} className={iconClass} />}
            label="Connected"
          >
          ...
          {isUserConnection ? null : (
            <>
              <PropertyRow
                icon={<HugeiconsIcon icon={Workflow} className={iconClass} />}
                label="Automations"
              >
                <Badge className="text-muted-foreground" variant="outline">
              ...
              <PropertyRow icon={<HugeiconsIcon icon={Bot} className={iconClass} />} label="Agents">
                <Badge className="text-muted-foreground" variant="outline">
          ...
          {lastRefreshAt ? (
            <PropertyRow
              icon={<HugeiconsIcon icon={RefreshCcw} className={iconClass} />}
