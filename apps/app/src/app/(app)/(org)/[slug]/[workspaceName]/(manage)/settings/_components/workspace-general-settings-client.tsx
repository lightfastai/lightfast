...
import type { WorkspaceSettingsFormValues } from "@repo/app-validation/forms";
import { workspaceSettingsFormSchema } from "@repo/app-validation/forms";
        ...
        if (previousList) {
          queryClient.setQueryData(
            ...
            produce(previousList, (draft) => {
              const workspaceIndex = draft.findIndex(
                (w) => w.id === workspace.id
              );
        ...
        <form className="space-y-8" onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Letters, numbers, hyphens, periods, and underscores (max
                      100 characters)
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="mt-1 text-muted-foreground text-sm">
                Auto-generated identifier used for Pinecone index naming. This
                cannot be changed.
              </p>
            </div>
