        ...
        >
            ...
            <div className="rounded-lg border border-border bg-background p-3">
              {model.organizations.length > 1 ? (
                <div className="space-y-2">
                  ...
                  >
                    <HugeiconsIcon icon={Building2} className="size-3.5" />
                    Organization
                  </label>
                  <input
                    name="organizationId"
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            {model.client.verified ? null : (
              <WarningRow
                icon={<HugeiconsIcon icon={AlertTriangle} className="size-4" />}
...
function ConnectionMarks({ clientName }: { clientName: string }) {
  return (
    <div className="flex items-center justify-center gap-3">
      ...
      <HugeiconsIcon icon={ArrowLeftRight} className="size-4 text-muted-foreground" />
      ...
      >
        <SheetHeader className="border-border/60 border-b px-5 py-5">
          <div className="mb-2 flex items-center gap-2.5">
            ...
            <HugeiconsIcon icon={ArrowLeftRight} className="size-3.5 text-muted-foreground" />
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-5 py-5">
          <dl className="space-y-0">
            <PropertyRow
              icon={<HugeiconsIcon icon={ShieldCheck} className="size-4" />}
              label="Client"
