...
- Do not execute actions that modify organization data. Your role is read-only search and analysis.
...
- Respect organization access boundaries. Only surface data from the organization the user is authenticated into.`;
