...
import { LOGO_CURVE, lissajousPoints } from "../../../shared/brand";
import type { Box3D, Face, Vec2 } from "../../../shared/iso";
import { createBox, facePath, project, silhouette } from "../../../shared/iso";
