 ...
 * 3. Fallback "external" — external webhook providers hit without custom headers
 */
 ...
 * duration_ms, source, provider, error.
 * Route handlers can enrich the log via c.set("logFields", { deliveryId, ... }).
 *
