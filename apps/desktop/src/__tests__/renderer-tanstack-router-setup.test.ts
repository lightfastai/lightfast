...
const primaryRouter = readFileSync(
  new URL("../renderer/src/react/primary-router.tsx", import.meta.url),
  "utf8"
);
const rootRoute = readFileSync(
  new URL("../renderer/src/routes/__root.tsx", import.meta.url),
  "utf8"
);
const indexRoute = readFileSync(
  new URL("../renderer/src/routes/index.tsx", import.meta.url),
  "utf8"
);
