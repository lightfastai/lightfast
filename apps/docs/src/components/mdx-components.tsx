...
const components = {
  ...
  pre: ({
    ...
    return (
      <>
        <pre
          className={cn(
            "mt-6 mb-4 max-h-[650px] overflow-x-auto rounded-lg border bg-zinc-900 px-4 py-4 dark:bg-zinc-900",
            className,
          )}
          {...props}
        />
  ...
  code: ({ className, ...props }: React.HTMLAttributes<HTMLElement>) => (
    <code
      className={cn(
        "relative bg-zinc-900 px-[0.3rem] py-[0.2rem] font-mono text-sm",
        className,
      )}
      {...props}
    />
