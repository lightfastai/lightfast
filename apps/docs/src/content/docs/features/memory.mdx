...
description: How Lightfast structures knowledge into chunks, observations, summaries, and profiles
---

# Memory Organization

Lightfast structures your team's knowledge into four complementary layers, each optimized for different types of retrieval and reasoning. This organization enables both precise lookups and broad exploration.
...
- **Team insights**: Understand collaboration patterns and knowledge distribution
