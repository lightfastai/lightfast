...
- **Bun**: Version 1.2.10 or higher (required)
...
SKIP_ENV_VALIDATION=true bun run build:www
...
1. 📖 Continue to [Quickstart](/docs/getting-started/quickstart) for using the chat
2. ⚙️ Learn about [Configuration](/docs/getting-started/configuration) options
3. 🚀 Explore [Deployment](/docs/guides/deployment) for production
4. 👨‍💻 Check [Development Setup](/docs/development/setup) for contributing
