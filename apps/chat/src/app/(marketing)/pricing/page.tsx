...
export const metadata: Metadata = createMetadata({
	...
	description:
		"Lightfast Chat is completely free and open-source. No hidden costs, no subscription fees. Download, self-host, or use our hosted version for free. Compare our pricing with other AI chat platforms.",
	openGraph: {
		title: "Lightfast Chat Pricing - Free Open-Source AI Chat Interface",
		description:
			"Completely free and open-source AI chat interface. No subscription fees. Self-host or use our hosted version for free.",
