...
export function ZustandDebugPanel() {
  ...
  const jumpToPhase = useLandingPhaseStore((state) => state.jumpToPhase);
  const reset = useLandingPhaseStore((state) => state.reset);
  const enableWheel = useLandingPhaseStore((state) => state.enableWheel);
  const disableWheel = useLandingPhaseStore((state) => state.disableWheel);
