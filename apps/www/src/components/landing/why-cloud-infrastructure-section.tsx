						...
						<div className="space-y-8">
							<div className="space-y-3">
								...
								<p className="text-muted-foreground">
									Individual agents have limited context windows (1, MaxToken_x].
									Pollution degrades the token graph. Our platform manages
									context construction across multi-agent hierarchies without degradation.
								</p>
							</div>
							...
							<div className="space-y-3">
								...
								<p className="text-muted-foreground">
									Multi-agent coordination requires stateful context and fine-grain
									control. We provide the orchestration layer for subagent
									hierarchies to collaborate seamlessly.
								</p>
							</div>
							...
							<div className="space-y-3">
								...
								<p className="text-muted-foreground">
									AI-native workflows need more than trigger-action chains.
									Our state-machine engine orchestrates multi-step workflows with
