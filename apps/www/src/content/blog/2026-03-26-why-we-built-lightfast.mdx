...
faq:
  ...
  - question: "What has Lightfast shipped so far?"
    answer: "Lightfast v0.1.0 ships a neural pipeline that extracts entities and relationships from GitHub, Vercel, Linear, and Sentry events, plus an AI chat interface (Explore), a REST API, a TypeScript SDK, and an MCP server for agent integration. The substrate is live and in production."
---
