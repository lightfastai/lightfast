---
title: MCP Server
description: Model Context Protocol server API reference for integrating AI assistants with Lightfast workspace memory.
keywords:
  - MCP server
...
ogDescription: Model Context Protocol server API reference for integrating AI assistants with Lightfast workspace memory.
ogImage: https://lightfast.ai/og/docs/api/mcp-server.jpg
authors:
  - name: Lightfast Team
