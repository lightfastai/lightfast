---
title: API Overview
description: "Introduction to the Lightfast REST API — three core routes for team memory: search, contents, and similar endpoints."
keywords:
  - API overview
  - REST API
  - search endpoint
...
ogDescription: "Introduction to the Lightfast REST API — three core routes for team memory: search, contents, and similar endpoints."
ogImage: https://lightfast.ai/og/docs/api/overview.jpg
authors:
  - name: Lightfast Team
