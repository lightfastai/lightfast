...
description: Authenticate with the Lightfast API using API keys or session-based auth for secure workspace access and requests.
keywords:
  - API authentication
  - API keys
  - session auth
...
ogDescription: Authenticate with the Lightfast API using API keys or session-based auth for secure workspace access and requests.
ogImage: https://lightfast.ai/og/docs/api/authentication.jpg
authors:
  - name: Lightfast Team
...
- **[POST /v1/contents](/api/endpoints/contents)** - Retrieve full content by ID
- **[POST /v1/findsimilar](/api/endpoints/findsimilar)** - Find semantically similar content
