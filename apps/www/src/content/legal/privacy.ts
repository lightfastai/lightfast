export const privacyContent = `# Lightfast Privacy Policy
...
**An Important Note:** This Privacy Policy does not apply to any of the personal information that our customers may collect and process using Lightfast's Services ("Customer Data"). Our customers' respective privacy policies govern their collection and use of Customer Data. Our processing of Customer Data is governed by the agreements that we have in place with our customers, not this Privacy Policy. Any questions or requests relating to Customer Data should be directed to the appropriate customer.
...
**Account Creation.** We may collect information when you create an account, such as your name, email address, and desired username. For enterprise users, we may also collect information from you, including the name and address of your company and your role with respect to the company. We may further collect information about authorized users who you authorize to use the Services on behalf of your company.
...
**Your Communications with Us.** We may collect personal information, such as your name, email address, phone number, or mailing address when you request information about our Services, register for our newsletter, request customer or technical support, apply for a job, or otherwise communicate with us.
...
**Crash Reports.** If you send them, we may also collect personal information related to such crash reports, including detailed diagnostic information about your device and the activities that led to the crash.
...
- **Functionality-Related.** We may use Technologies that allow us to offer you enhanced functionality when accessing or using our Services. This may include identifying you when you sign into our Services or keeping track of your specified preferences, interest, or past items viewed; and
...
- **Google Analytics.** For more information about how Google uses your personal information (including for its own purposes, e.g. for profiling or linking it to other data), please visit Google Analytics' Privacy Policy. To learn more about how to opt-out of Google Analytics' use of your information, please click [here](https://tools.google.com/dlpage/gaoptout).

**Social Media Platforms.** Our Services may contain social media buttons, such as Twitter or GitHub (which might include widgets such as the "share this" button or other interactive mini programs). These features may collect personal information, such as your IP address and which page you are visiting on our Services, and may set a cookie to enable the feature to function properly. Your interactions with these platforms are governed by the privacy policy of the company providing it.

### Information Collected from Other Sources

**Third-party Services.** We may obtain information about you from other sources, including through third-party services and organizations. For example, if you access our Services through a third-party application, such as an app store, a third-party login service, or a social networking site, we may collect information about you from that third-party application that you have made available via your privacy settings.
...
We use your personal information in our legitimate interest, or to comply with our legal obligations, such as:
...
We may use personal information to tailor and provide you with content and advertisements. We may provide you with these materials as permitted by applicable law. Some of the ways we market to you include email campaigns and custom audiences advertising.
...
**De-identified and Aggregated Information.** We may use personal information and other information about you to create de-identified and/or aggregated information, such as de-identified demographic information, de-identified location information, information about the device from which you access our Services, or other analyses we create. If we create or receive personal data that has been de-identified or aggregated, we will not attempt to reidentify it, except to comply with applicable law.
...
All personal information processed by us may be transferred, processed, and stored anywhere in the world, including, but not limited to, Australia, the United States or other countries, which may have data protection laws that are different from the laws where you live.
...
As an Australian company, we are committed to complying with the Privacy Act 1988 (Cth) and the Australian Privacy Principles (APPs). We handle personal information in accordance with these principles, which govern:

- **Open and transparent management** of personal information
- **Anonymity and pseudonymity** options where lawful and practicable
- **Collection** of solicited personal information only when reasonably necessary for our functions
- **Dealing with unsolicited personal information** appropriately
- **Notification** of the collection of personal information
- **Use and disclosure** of personal information only for authorized purposes
- **Direct marketing** in compliance with your preferences
- **Cross-border disclosure** of personal information with appropriate safeguards
- **Quality** of personal information to ensure accuracy and completeness
- **Security** of personal information through reasonable steps to protect it
- **Access** to personal information upon request
- **Correction** of personal information when necessary

If you are an Australian resident, you have the right to:
- Access your personal information held by us
- Request correction of inaccurate personal information
- Request that we stop using your personal information for direct marketing purposes
- Make a complaint to us or to the Office of the Australian Information Commissioner (OAIC)

For more information about your privacy rights, please visit the [OAIC website](https://www.oaic.gov.au/).

## 9. INTERNATIONAL COMPLIANCE

### European Union and United Kingdom Residents
If you are located in the EU or UK, you have rights under the General Data Protection Regulation (GDPR) or UK GDPR, including the right to access, rectify, erase, restrict processing, data portability, and object to processing of your personal information.

### California Residents
**California Shine the Light.** California residents may request information about third parties to whom we have disclosed personal information for direct marketing purposes.

**Right for minors to remove posted content.** California residents under 18 may request removal of their posted content from publicly-viewable portions of the Services.

### Nevada Residents
Nevada residents may opt-out of the sale of certain Personal Information to third parties. Contact us at legal@lightfast.ai with the subject line "Nevada Do Not Sell Request". Note that we do not currently sell Personal Information as defined in Nevada law.
...
**Supervisory Authority.** In addition to the Australian OAIC, if you are located in the European Economic Area, Switzerland, the United Kingdom, or Brazil, you have the right to lodge a complaint with your local supervisory authority if you believe our processing of your personal information violates applicable law.
