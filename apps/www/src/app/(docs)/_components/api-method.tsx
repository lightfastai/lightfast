...
export const methodColors: Record<HttpMethod, string> = {
  ...
  PATCH:
    "bg-purple-500/10 text-purple-600 border-purple-500/20 dark:bg-purple-500/10 dark:text-purple-400 dark:border-purple-500/30",
  DELETE:
    "bg-red-500/10 text-red-600 border-red-500/20 dark:bg-red-500/10 dark:text-red-400 dark:border-red-500/30",
};
...
export function ApiMethod({ method, className }: ApiMethodProps) {
  return (
    <span
      className={cn(
        "inline-flex items-center justify-center rounded-md border px-2 py-0.5 font-bold text-[10px] uppercase tracking-wider",
        methodColors[method],
        className
      )}
    >
