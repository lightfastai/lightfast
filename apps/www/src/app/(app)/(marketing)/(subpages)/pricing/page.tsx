...
export const metadata: Metadata = {
	...
	description: "Pricing starts free with 5 integrations and 100 workflow runs per month. Scale with Pro ($29/mo) or Team ($99/mo). Open-source and self-hostable.",
	keywords: [
	...
	openGraph: {
		title: "Pricing - AI Workflow Automation Platform",
		description: "Simple, transparent pricing for AI workflow automation. Start free with 5 integrations. Scale with Pro or Team plans.",
