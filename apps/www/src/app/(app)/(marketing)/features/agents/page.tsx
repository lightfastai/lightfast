...
export const metadata: Metadata = createMetadata({
  title: "For Agents",
  description: "Lightfast for Agents. Stay tuned for updates.",
  alternates: {
      ...
      <div className="space-y-12 text-foreground">
        <article className="border-l-2 border-border pl-8 py-4">
          ...
          <p className="text-foreground/80 leading-relaxed">
            We're working on building something incredible. Agent features, examples, and demos will appear here as we progress.
          </p>
        </article>
      </div>
    </>
