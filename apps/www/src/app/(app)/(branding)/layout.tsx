 ...
 * Provides header navigation but allows each page to control its own content structure
 * and whether to include footer sections.
 */
  ...
  return (
    <div className="manifesto-page flex flex-col bg-background min-h-screen overflow-x-hidden">
      <div className="bg-background">
        ...
        {/* Page content - each branding page controls its own structure */}
        {children}
      </div>
    </div>
  );
